...
├── hooks/hooks.json             # Codex plugin lifecycle hook configuration
│
...
| Codex | Root `.codex-plugin/plugin.json`, skills, and `hooks/hooks.json` | Yes — SessionStart activation plus UserPromptSubmit tracking |
