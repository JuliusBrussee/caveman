...
description: >
  ...
  dnd (silent while working, report once done), wenyan-lite, wenyan-full, wenyan-ultra.
  Use when user says "caveman mode", "talk like caveman", "use caveman", "less tokens",
  "be brief", "dnd", "do not disturb", "work silently", or invokes /caveman. Also auto-triggers
...
Default: **full**. Switch: `/caveman lite|full|ultra|dnd|wenyan-lite|wenyan-full|wenyan-ultra|off`.
...
| **dnd** | Do not disturb. Silent while working. No prose between tool calls: no preamble, no plan, no progress note, no narration, no running commentary, no "next I will". Thinking unrestricted, no limit on reasoning. Speak only three times: one terse final report when job done (ultra rules), a question when request ambiguous, a confirm request when action needs approval. Auto-Clarity below still overrides: security warning and irreversible-action confirm always speak, whenever they arise |
...
- dnd: silence while working; final report only: "Inline obj prop, new ref, re-render. `useMemo`."
...
- dnd: silence while working; final report only: "Pool reuse open DB connections. No per-request handshake."
