...
const PACKAGE_ROOT = existsSync(resolve(REPO_ROOT, "public/shared/provider-catalog/catalog/current.yaml"))
  ? resolve(REPO_ROOT, "public")
  : resolve(REPO_ROOT, "packages");
export const CATALOG_PATH = resolve(PACKAGE_ROOT, "shared/provider-catalog/catalog/current.yaml");
export const OUTPUT_PATH = resolve(PACKAGE_ROOT, "agent/src/catalog.ts");
