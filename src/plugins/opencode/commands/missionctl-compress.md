---
description: Compress a markdown/text file into missionctl format to save tokens
---
Compress the file at: $ARGUMENTS

Run the `missionctl-compress` skill against the given filepath. The skill rewrites
prose into terse missionctl style — drops articles, filler, hedging — while
