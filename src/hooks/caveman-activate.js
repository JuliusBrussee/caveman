...
if (skillContent) {
  ...
  output =
    ...
    "Preserve user's dominant language (default to English). User write Portuguese → reply Portuguese caveman. Compress the style, not the language. Technical terms, code, API names, commands, error strings stay verbatim.\n\n" +
