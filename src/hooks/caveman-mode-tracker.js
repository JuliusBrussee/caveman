...
process.stdin.on('end', () => {
  try {
    ...
    //
    // Conflict detection: if another token-compression plugin is active
    // (ponytail, grill-me, etc.), reduce to a minimal one-liner instead of the
    // full reminder to avoid injecting contradictory style instructions.
