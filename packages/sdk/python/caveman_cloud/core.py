...
def _policy_int(value: Any) -> int | float | None:
    ...
    same counter; the TypeScript mirror accepts any finite number here. Booleans
    are excluded — ``True`` is not version 1.
    """
    ...
    def _accept(self, payload: Any) -> RuntimePolicyRefresh:
        ...
        with self._lock:
            ...
            if isinstance(cached, dict):
                ...
                if incoming_seq is not None and cached_seq is not None and incoming_seq < cached_seq:
