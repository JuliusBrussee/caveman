...
const canonicalLearn = join(here, "..", "..", "skills", "caveman-learn", "SKILL.md");
const canonicalCaveman = join(here, "..", "..", "skills", "caveman", "SKILL.md");
const canonicalExplore = join(here, "..", "..", "skills", "caveman-explore", "SKILL.md");
...
test("skills with no subcommand prints usage and exits non-zero", async () => {
  ...
  assert.match(out.stderr, /usage: caveman skills install/);
});
