...
test("CLI method mirror matches the Go verified-method registry", () => {
  const goSource = readFileSync(join(here, "..", "..", "..", "cloud", "internal", "verifiedmethod", "verifiedmethod.go"), "utf8");
