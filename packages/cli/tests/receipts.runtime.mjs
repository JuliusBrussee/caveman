...
function signedReceipt({ key, scope, seq, day, prev = "", tokensBefore = 100, tokensAfter = 70, schema = "caveman.receipt.v2", savings = 1.25, formula = "verified-savings-ledger.v1", passed = 2, failed = 0, catalogVersion = "2026-07-10" }) {
  const core = {
    schema,
    scope,
    day,
