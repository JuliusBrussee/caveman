...
}, /must be one cave template token or a safe literal/);
...
test("reserved command source covers every dispatched and namespace token", () => {
  ...
  const expected = [
    ...
    "convert", "costs", "deploy", "dev", "doctor", "evals", "experiments", "explore",
    "help", "hooks", "init", "keys", "learn", "login", "logout", "mcp", "mem",
    "opportunities", "plan", "projects", "providers", "receipts", "retrieve", "run",
