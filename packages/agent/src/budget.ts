...
export interface RunBudget {
  ...
  /**
   * What the run does when the reserve check fails. `"compact"` is
   * the default: compress the context and carry on, spending the compaction
   * inside the same cap. `"stop"` skips straight to clamping and stopping.
   */
