...
function queryFn(capture, outputTokens = 5, model = "claude-haiku-4-5") {
...
test("a Claude run that errors after spending surfaces its receipt", async () => {
  // error_max_turns after burning turns/dollars must not throw the ledger away:
