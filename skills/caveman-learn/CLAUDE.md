...
## Install path
`caveman skills install caveman-learn` (in `../../cli/src/index.ts`) writes this file
...
See ../../../docs/CAVEMAN_LEARN_SPEC.md · ../../mem/CLAUDE.md (cavemem) · ../../explorer/CLAUDE.md (the packaging precedent)
