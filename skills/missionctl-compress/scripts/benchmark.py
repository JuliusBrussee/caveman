...
def main():
    ...
    # Glob mode: repo_root/tests/missionctl-compress/
    # __file__ lives at <repo_root>/skills/missionctl-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → missionctl-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "missionctl-compress"
